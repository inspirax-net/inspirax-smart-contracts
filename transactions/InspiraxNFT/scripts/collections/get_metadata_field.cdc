...
// for that play's metadata in the Inspirax contract. It returns
...
pub fun main(account: Address, momentID: UInt64, fieldToSearch: String): String {
    ...
    let field = Inspirax.getPlayMetaDataByField(playID: data.playID, field: fieldToSearch) ?? panic("Play doesn't exist")
